...
################################################################
# This is a generated script based on design: design_ov
#
...
# source design_ov_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# OV_Sensor_ML, rgb_change
...
proc create_root_design { parentCell } {
  ...
  set cmos_pwdn [ create_bd_port -dir O -from 0 -to 0 cmos_pwdn ]
  set cmos_reset_tri_o [ create_bd_port -dir O -from 0 -to 0 cmos_reset_tri_o ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT3_JITTER {198.227} \
   CONFIG.CLKOUT3_PHASE_ERROR {128.132} \
  ...
  connect_bd_intf_net -intf_net axi_iic_0_IIC [get_bd_intf_ports cmos_i2c] [get_bd_intf_pins axi_iic_0/IIC]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins axi_uartlite_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M03_AXI]
  ...
  connect_bd_net -net OV_Sensor_ML_0_cmos_xclk_o [get_bd_ports cmos_xclk_o_0] [get_bd_pins OV_Sensor_ML_0/cmos_xclk_o]
  ...
  connect_bd_net -net clk_wiz_0_clk_24M [get_bd_pins OV_Sensor_ML_0/CLK_i] [get_bd_pins clk_wiz_0/clk_24M]
  ...
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins rgb2dvi_0/SerialClk] [get_bd_pins rst_clk_wiz_0_125M/slowest_sync_clk]
  ...
  connect_bd_net -net cmos_data_i_0_1 [get_bd_ports cmos_data_i_0] [get_bd_pins OV_Sensor_ML_0/cmos_data_i]
  connect_bd_net -net cmos_href_i_0_1 [get_bd_ports cmos_href_i_0] [get_bd_pins OV_Sensor_ML_0/cmos_href_i]
  connect_bd_net -net cmos_pclk_i_0_1 [get_bd_ports cmos_pclk_i_0] [get_bd_pins OV_Sensor_ML_0/cmos_pclk_i] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_clk]
  connect_bd_net -net cmos_vsync_i_0_1 [get_bd_ports cmos_vsync_i_0] [get_bd_pins OV_Sensor_ML_0/cmos_vsync_i]
  ...
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_clk_wiz_0_125M/ext_reset_in] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rgb_change_0_rgb_out [get_bd_pins rgb2dvi_0/vid_pData] [get_bd_pins rgb_change_0/rgb_out]
  connect_bd_net -net rst_clk_wiz_0_125M_peripheral_aresetn [get_bd_pins rgb2dvi_0/aRst_n] [get_bd_pins rst_clk_wiz_0_125M/peripheral_aresetn]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins v_vid_in_axi4s_0/aresetn]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins rst_clk_wiz_0_125M/peripheral_reset] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_reset] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_reset]
  ...
  connect_bd_net -net v_axi4s_vid_out_0_vid_data [get_bd_pins rgb_change_0/rgb_in] [get_bd_pins v_axi4s_vid_out_0/vid_data]
  ...
  connect_bd_net -net xlconstant_1_dout [get_bd_ports cmos_pwdn] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_ports cmos_reset_tri_o] [get_bd_pins xlconstant_2/dout]
